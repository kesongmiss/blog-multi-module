...
public class ShiroConfig {
    ...
    private String host = "39.107.127.19";
    private int port = 6379;
    private String password = "1998816";
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        // 登录、登出，可以直接访问
        filterChainDefinitionMap.put("/tenero/login/**", "anon");
        // 登录后既可访问
        filterChainDefinitionMap.put("/tenero/friendchainlist/**", "authc");
...
//    }
    ...
    /**
     * Session 自定义 SessionID 生成器
     * @return CustomizeSessionIdGenerator
     */
    @Bean
    public CustomizeSessionIdGenerator sessionIdGenerator() {
        return new CustomizeSessionIdGenerator();
    }
    ...
    public SecurityManager securityManager() {
        ...
        securityManager.setRealm(doGetAuthorizationInfoimpl());
